...
User Function Mod1SA1()
    ...
    oBrowse:AddLegend(cOk      , "BR_VERDE"   , "Campos de Endere�o preenchidos")
...
Static Function MenuDef()
    ...
    ADD OPTION aRot TITLE 'Atualizar Endere�o por CEP (manual)  ' ACTION 'U_ModAtuWS()' OPERATION 4 ACCESS 0
    ADD OPTION aRot TITLE 'Atualizar Endere�o via CSV (em Massa)' ACTION 'U_ModAtuCsv()' OPERATION 4 ACCESS 0
...
User Function LegMod1()
    ...
    aAdd(aLegenda,{"BR_VERDE",        "Campos de Endere�o preenchidos"})
...
UsER Function ModAtuCsv()
    ...
    DEFINE MSDIALOG oDlg TITLE cTitulo FROM 000, 000  TO 160, 600 COLORS 0, 16777215 PIXEL
        ...
        TSay():New(010, 010, {|| "Rotina de Atualiza��o de dados de endere�o via csv;"}                             , oDlg, , , , , , .T., , , 200, 10)
        TSay():New(020, 010, {|| "A rotina ir� atualizar os dados de endere�o dos clientes;"}                       , oDlg, , , , , , .T., , , 200, 10)
...
Static Function BaixarCsv()
    ...
    if MsgNoYes("Deseja baixar o CSV de modelo para a atualiza��o de dados?")
...
Static Function ImpCsv()
    ...
    if  MsgNoYes("Deseja Prosseguir com a atualiza��o?")
        ...
        If !File(cArquivo)
            MsgStop("Arquivo CSV n�o encontrado!")
            Return
        EndIf
        ...
        If Len(aLinhas) <= 1
            MsgStop("Arquivo CSV vazio ou cont�m apenas cabe�alho!")
            Return
        EndIf
        ...
        For i := 2 to Len(aLinhas)
            ...
            IF lMsErroAuto
                ...
                nOpcAviso := Aviso("Erro na Importa��o",;
                cLog + CRLF + ;
                'Esta mensagem fechar� em 5 segundos. Para interromper o timer, selecione "Timer Off". ',;
                {"OK"},,, 1,,,5)
...
User Function ModAtuWs()
    ...
    DEFINE MSDIALOG oDlg TITLE cTitulo FROM 000, 000  TO 500, 700  PIXEL
        ...
        @ 040, 010 SAY "Endere�o:"    SIZE 050, 007 OF oDlg PIXEL
